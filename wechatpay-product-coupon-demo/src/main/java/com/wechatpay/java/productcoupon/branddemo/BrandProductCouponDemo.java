...
public class BrandProductCouponDemo {
    ...
    // ============ 品牌配置 ============
    // TODO: 请准备品牌开发必要参数，参考：https://pay.weixin.qq.com/doc/v3/brand/4013080339

    /** 品牌ID，由微信支付分配 */
    private static final String BRAND_ID = "YOUR_BRAND_ID";

    /** 品牌API证书序列号，如何获取请参考 https://pay.weixin.qq.com/doc/v3/brand/4013058923 */
    ...
    /** 微信支付公钥ID，如何获取请参考 https://pay.weixin.qq.com/doc/v3/brand/4013038588 */
