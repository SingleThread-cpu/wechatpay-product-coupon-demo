...
public class AllNormalMany {
  ...
  public static CreateProductCouponRequest buildRequest() {
    ...
    request.setOutRequestNo("MANY_ALL_NORMAL_20250101_002");
    // 必填，品牌ID，由微信支付分配
    ...
    progressiveBundleUsageInfo.setIntervalDays(1L);
    ...
    // 必填，商品券名称，最多12个字符
    displayInfo.setName("全场满100减15(可用3次)");
    // 必填，商品券图片URL
    ...
    request.setStockBundle(createStock("满100减15批次", 10000, 1500));
  ...
  private static StockForProgressiveBundle createStock(String remark, long threshold, long discountAmount) {
    ...
    normalCouponList.add(normalCoupon1);
    // 第2次使用
    ...
    normalCouponList.add(normalCoupon2);
    // 第3次使用
    ...
    normalCouponList.add(normalCoupon3);
