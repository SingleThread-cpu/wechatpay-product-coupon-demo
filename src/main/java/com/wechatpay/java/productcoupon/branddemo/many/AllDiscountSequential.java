 ...
 * type: DISCOUNT（折扣券）
 */
public class AllDiscountSequential {
  ...
  public static CreateProductCouponRequest buildRequest() {
    ...
    request.setOutRequestNo("MANY_ALL_DISCOUNT_20250101_001");
    // 必填，品牌ID，由微信支付分配
    ...
    // 必填，商品券名称，最多12个字符
    displayInfo.setName("全场8折券(可用3次)");
    // 必填，商品券图片URL
    ...
    request.setStockBundle(createStock("8折批次", 10000, 20));
