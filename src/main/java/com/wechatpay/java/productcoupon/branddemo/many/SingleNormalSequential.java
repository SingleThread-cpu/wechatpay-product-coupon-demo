 ...
 * type: NORMAL（满减券）
 */
public class SingleNormalSequential {
  ...
  public static CreateProductCouponRequest buildRequest() {
    ...
    request.setOutRequestNo("MANY_SINGLE_NORMAL_20250101_001");
    // 必填，品牌ID，由微信支付分配
    request.setBrandId("120344");
    // 选填，商户侧商品券唯一标识
    request.setOutProductNo("Product_1234567893");
    ...
    // 必填，商品券名称，最多12个字符
    displayInfo.setName("满50减10(可用3次)");
    // 必填，商品券图片URL
    ...
    request.setStockBundle(createStock("单品满减批次", 5000, 1000));
